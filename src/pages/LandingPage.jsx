    ...
    <div>
      ...
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        <section className="py-16 pb-12 border-b border-line">
          <p className="font-mono text-[11px] uppercase tracking-[0.1em] text-accent-dark mb-[18px] m-0">
            venta directa entre productores y compradores locales
          </p>
          <h2 className="font-display font-medium text-[52px] leading-[1.06] tracking-[-0.015em] max-w-[760px] mt-0 mb-[22px] max-md:text-[36px]">
            Del cultivo a tu negocio, sin pasar por seis manos.
          </h2>
          <p className="text-[16.5px] leading-relaxed text-ink-soft max-w-[520px] mt-0 mb-8">
          ...
          <div className="flex gap-3 flex-wrap mb-14">
            <button
              ...
              className="bg-ink text-paper border border-ink rounded-[4px] px-5 py-3 font-mono text-[13px] cursor-pointer"
            >
              Soy comprador
            </button>
            <button
              ...
              className="bg-transparent text-ink border border-line-strong rounded-[4px] px-5 py-3 font-mono text-[13px] cursor-pointer"
            >
              Soy productor
            </button>
          </div>
          ...
          {/* Cadena de valor */}
          <div className="border border-line bg-card rounded-[6px] p-6 px-7">
        ...
        <section className="py-14 border-b border-line">
          ...
          <div className="flex flex-wrap gap-2">
            {MUNICIPIOS.map(({ valor, label }) => (
              <span
                key={valor}
                className="font-mono text-[11.5px] text-ink-soft border border-line rounded-full px-3 py-[5px]"
              >
                {label}
              </span>
            ))}
